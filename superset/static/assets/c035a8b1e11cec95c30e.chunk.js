(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[7875],{
...
function create(node, id, config) {
  ...
  transition.timer = (0,timer/* timer */.HT)(schedule, 0, transition.time);
  ...
  function start(elapsed) {
    ...
    for (var sid in schedules) {
      ...
      if (s.state === STARTED) return (0,timeout/* default */.Z)(start); // 1. Interrupt the active transition, if any. dispatch the interrupt event.
