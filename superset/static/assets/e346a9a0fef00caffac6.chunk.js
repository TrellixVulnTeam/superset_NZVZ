"use strict";
(globalThis["webpackChunksuperset"] = globalThis["webpackChunksuperset"] || []).push([[326],{
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
/** @format */
__export(__webpack_require__(82790));
...
/** @format */
Object.defineProperty(exports, "__esModule", ({ value: true }));
var colors_1 = __webpack_require__(36574);
// compile this once
...
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(50855);
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(63758);
...
/* harmony import */ var emotion_rgba__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49484);
/* harmony import */ var emotion_rgba__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(emotion_rgba__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74448);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(56080);
...
const Wrapper = _superset_ui_core__WEBPACK_IMPORTED_MODULE_5__/* .styled.div */ .iK.div`
  ${({ theme, validateStatus }) => {var _theme$colors, _theme$colors2, _theme$colors$validat, _theme$colors$validat2, _theme$colors3, _theme$colors$validat3, _theme$colors$validat4;return `
    ...
    &:focus {
      ...
      box-shadow: 0 0 0 3px
        ${(0,emotion_rgba__WEBPACK_IMPORTED_MODULE_2__.rgba)((_theme$colors2 = theme.colors[validateStatus || 'primary']) == null ? void 0 : _theme$colors2.base, 0.2)};
    }
    & .ant-slider {
      ...
      & .ant-slider-handle {
        ...
        &:focus {
          box-shadow: 0 0 0 3px
            ${(0,emotion_rgba__WEBPACK_IMPORTED_MODULE_2__.rgba)((_theme$colors3 = theme.colors[validateStatus || 'primary']) == null ? void 0 : _theme$colors3.base, 0.2)};
        }
      }
      &:hover {
        & .ant-slider-track {
...
function RangeFilterPlugin(props) {
  ...
  const numberFormatter = (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__/* .getNumberFormatter */ .JB)(_superset_ui_core__WEBPACK_IMPORTED_MODULE_7__/* ["default"].SMART_NUMBER */ .Z.SMART_NUMBER);
  const [row] = data;
  // @ts-ignore
  const { min, max } = row;
  const { groupby, defaultValue, inputRef } = formData;
  const [col = ''] = groupby || [];
  const [value, setValue] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(defaultValue != null ? defaultValue : [min, max]);
  ...
  const handleAfterChange = (value) => {
    ...
    setDataMask({
      extraFormData: (0,_utils__WEBPACK_IMPORTED_MODULE_4__/* .getRangeExtraFormData */ .WO)(col, lower, upper),
      filterState: {
  ...
  if (filterState.validateMessage) {
    formItemData.extra = (0,_emotion_react__WEBPACK_IMPORTED_MODULE_8__.jsx)(_common__WEBPACK_IMPORTED_MODULE_3__/* .StatusMessage */ .Am, { status: filterState.validateStatus },
    filterState.validateMessage);

  }
  return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_8__.jsx)(_common__WEBPACK_IMPORTED_MODULE_3__/* .FilterPluginStyle */ .un, { height: height, width: width },
  Number.isNaN(Number(min)) || Number.isNaN(Number(max)) ? (0,_emotion_react__WEBPACK_IMPORTED_MODULE_8__.jsx)("h4", null, (0,_superset_ui_core__WEBPACK_IMPORTED_MODULE_9__.t)('Chosen non-numeric column')) : (0,_emotion_react__WEBPACK_IMPORTED_MODULE_8__.jsx)(_common__WEBPACK_IMPORTED_MODULE_3__/* .StyledFormItem */ .jp, formItemData,
  (0,_emotion_react__WEBPACK_IMPORTED_MODULE_8__.jsx)(Wrapper, { tabIndex: -1, ref: inputRef, validateStatus: filterState.validateStatus, onFocus: setFocusedFilter, onBlur: unsetFocusedFilter, onMouseEnter: setFocusedFilter, onMouseLeave: unsetFocusedFilter },
  (0,_emotion_react__WEBPACK_IMPORTED_MODULE_8__.jsx)(src_common_components__WEBPACK_IMPORTED_MODULE_1__/* .Slider */ .iR, { range: true, min: min, max: max, value: value != null ? value : [min, max], onAfterChange: handleAfterChange, onChange: handleChange, tipFormatter: (value) => numberFormatter(value), marks: marks }))));
...
/* harmony import */ var src_utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(57448);
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
