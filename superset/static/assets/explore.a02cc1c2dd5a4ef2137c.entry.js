...
var loggerMiddleware = __webpack_require__(60731);
...
var store = __webpack_require__(77722);
...
var reports = __webpack_require__(76690);
...
var reducers = __webpack_require__(99103);
...
// EXTERNAL MODULE: ./src/setup/setupPlugins.ts + 46 modules
var setupPlugins = __webpack_require__(82893);
...
var actions_reports = __webpack_require__(65181);
...
var dates = __webpack_require__(36883);
...
;// CONCATENATED MODULE: ./src/common/hooks/useUrlShortener.ts
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
function useUrlShortener(url) {
  const [update, setUpdate] = (0,react.useState)(false);
  const [shortUrl, setShortUrl] = (0,react.useState)('');
  async function getShortUrl() {
    if (update) {
      const newShortUrl = await (0,urlUtils/* getShortUrl */.O)(url);
  ...
  (0,react.useEffect)(() => setUpdate(true), [url]);
  return getShortUrl;
}
...
var common = __webpack_require__(57448);
...
;// CONCATENATED MODULE: ./src/explore/components/RowCountLabel.jsx
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
function RowCountLabel({ rowcount, limit, suffix, loading }) {
  ...
  const formattedRowCount = (0,NumberFormatterRegistrySingleton/* getNumberFormatter */.JB)()(rowcount);
  const tooltip =
  (0,emotion_react_browser_esm.jsx)("span", null,
  limitReached && (0,emotion_react_browser_esm.jsx)("div", null, (0,TranslatorSingleton.t)('Limit reached')),
  loading ? 'Loading' : rowcount);


  return (
    (0,emotion_react_browser_esm.jsx)(Tooltip/* Tooltip */.u, { id: "tt-rowcount-tooltip", title: tooltip },
    (0,emotion_react_browser_esm.jsx)(Label/* default */.Z, { type: type },
...
RowCountLabel.propTypes = RowCountLabel_propTypes;
RowCountLabel.defaultProps = defaultProps;
;// CONCATENATED MODULE: ./src/explore/components/DataTableControl/index.tsx
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const CopyButton = (0,style/* styled */.iK)(Button/* default */.Z)`
...
`;
const CopyNode = (0,emotion_react_browser_esm.jsx)(CopyButton, { buttonSize: "xsmall" },
(0,emotion_react_browser_esm.jsx)("i", { className: "fa fa-clipboard" }));

const CopyToClipboardButton = ({ data, columns }) => (0,emotion_react_browser_esm.jsx)(CopyToClipboard/* default */.Z, { text: data && columns ? (0,common/* prepareCopyToClipboardTabularData */.Mv)(data, columns) : '', wrapped: false, copyNode: CopyNode });
const FilterInput = ({ onChangeHandler }) => {
  const debouncedChangeHandler = debounce_default()(onChangeHandler, src_constants/* SLOW_DEBOUNCE */.M$);
  return (0,emotion_react_browser_esm.jsx)(components/* Input */.II, { placeholder: (0,TranslatorSingleton.t)('Search'), onChange: (event) => {
      const filterText = event.target.value;
      debouncedChangeHandler(filterText);
    } });
};
const RowCount = ({ data, loading }) => {var _data$length;return (0,emotion_react_browser_esm.jsx)(RowCountLabel, { rowcount: (_data$length = data == null ? void 0 : data.length) != null ? _data$length : 0, loading: loading, suffix: (0,TranslatorSingleton.t)('rows retrieved') });};
const useFilteredTableData = (filterText, data) => (0,react.useMemo)(() => {
  if (!(data != null && data.length)) {
    return [];
  }
  const formattedData = (0,common/* applyFormattingToTabularData */.cD)(data);
...
const useTableColumns = (colnames, data, moreConfigs) => (0,react.useMemo)(() => colnames && data != null && data.length ?
colnames.
...
map((key) => ({
  ...
  Cell: ({ value }) => {
    if (value === true) {
      return src_constants/* BOOL_TRUE_DISPLAY */.Ly;
    }
    if (value === false) {
      return src_constants/* BOOL_FALSE_DISPLAY */.gz;
    }
    return String(value);
  },
...
// EXTERNAL MODULE: ./node_modules/react-syntax-highlighter/dist/cjs/languages/hljs/markdown.js
var markdown = __webpack_require__(53459);
// EXTERNAL MODULE: ./node_modules/react-syntax-highlighter/dist/cjs/languages/hljs/htmlbars.js
var htmlbars = __webpack_require__(49889);
// EXTERNAL MODULE: ./node_modules/react-syntax-highlighter/dist/cjs/languages/hljs/sql.js
var sql = __webpack_require__(33743);
// EXTERNAL MODULE: ./node_modules/react-syntax-highlighter/dist/cjs/languages/hljs/json.js
var json = __webpack_require__(22489);
;// CONCATENATED MODULE: ./src/explore/components/controls/ViewQueryModal.tsx
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const CopyButtonViewQuery = (0,style/* styled */.iK)(CopyButton)`
  && {
    margin: 0 0 ${({ theme }) => theme.gridUnit}px;
  }
`;
light/* default.registerLanguage */.Z.registerLanguage('markdown', markdown/* default */.Z);
light/* default.registerLanguage */.Z.registerLanguage('html', htmlbars/* default */.Z);
light/* default.registerLanguage */.Z.registerLanguage('sql', sql/* default */.Z);
light/* default.registerLanguage */.Z.registerLanguage('json', json/* default */.Z);
const StyledSyntaxContainer = style/* styled.div */.iK.div`
  height: 100%;
`;
...
const ViewQueryModal = (props) => {
  ...
  const loadChartData = (resultType) => {
    ...
    then(({ json }) => {
      setResult((0,ensureIsArray/* default */.Z)(json.result));
      setIsLoading(false);
      setError(null);
    }).
    catch((response) => {
      (0,getClientErrorObject/* getClientErrorObject */.O)(response).then(({ error, message }) => {
        ...
        message ||
        response.statusText ||
        (0,TranslatorSingleton.t)('Sorry, An error occurred'));
        setIsLoading(false);
      });
    });
  };
  ...
  if (error) {
    return (0,emotion_react_browser_esm.jsx)("pre", null, error);
  }
  return (0,emotion_react_browser_esm.jsx)(react.Fragment, null,
  result.map((item) => item.query ? (0,emotion_react_browser_esm.jsx)(StyledSyntaxContainer, { key: item.query },
  (0,emotion_react_browser_esm.jsx)(CopyToClipboard/* default */.Z, { text: item.query, shouldShowText: false, copyNode: (0,emotion_react_browser_esm.jsx)(CopyButtonViewQuery, { buttonSize: "xsmall" },
    (0,emotion_react_browser_esm.jsx)("i", { className: "fa fa-clipboard" })) }),

  (0,emotion_react_browser_esm.jsx)(StyledSyntaxHighlighter, { language: item.language || undefined, style: github/* default */.Z },
  item.query)) :

  null));

};
/* harmony default export */ const controls_ViewQueryModal = (ViewQueryModal);
  ...
  return (
    (0,emotion_react_browser_esm.jsx)(components/* Dropdown */.Lt, {
      ...
      (0,emotion_react_browser_esm.jsx)(ModalTrigger/* default */.Z, {
        ...
        modalBody:
        (0,emotion_react_browser_esm.jsx)(controls_ViewQueryModal, {
...
class ExploreChartHeader extends react.PureComponent {
  ...
  render() {
    ...
    return (
      ...
      (0,emotion_react_browser_esm.jsx)(RowCountLabel, {
...
const DataTablesPane = ({ queryFormData, tableSectionHeight, onCollapseChange, chartStatus, ownState, errorMessage, queriesResponse }) => {
  ...
  (0,emotion_react_browser_esm.jsx)(RowCount, { data: data[activeTabKey], loading: isLoading[activeTabKey] }),
  (0,emotion_react_browser_esm.jsx)(CopyToClipboardButton, { data: data[activeTabKey], columns: columnNames }),
  (0,emotion_react_browser_esm.jsx)(FilterInput, { onChangeHandler: setFilterText }));
...
var Control = __webpack_require__(87428);
...
const QueryAndSaveBtns_defaultProps = {
  onStop: () => {},
  onSave: () => {} };
...
QueryAndSaveBtns.defaultProps = QueryAndSaveBtns_defaultProps;
...
/******/ 			// return url for filenames not based on template
/******/ 			if (chunkId === 9782) return "explore.a02cc1c2dd5a4ef2137c.entry.css";
/******/ 			// return url for filenames based on template
/******/ 			return "" + chunkId + "." + {"3":"801697eb5ab3352c42e5","128":"09f443525fca060387ee","423":"43b7f1dc864bda28fec5","823":"858db93d79a30d077534","1066":"ca1490ad3425672ef184","1193":"94f2747dbe0f34df1a7a","1243":"f76776ecfb675107b048","1391":"30c621e164b402fa5061","1921":"1a13273a93f7b61afaa9","2862":"c3663bc60ac90c9908a0","3609":"1b8c59ecc4d58f21e636","3776":"de42ae55420f8a80a0d6","4192":"30b753df2dcb91b99aec","4473":"53278bbc4be882db0f5c","5278":"5f8aa9f6cc9941f7cd09","5322":"f3dc5ba9b3f248da30c9","5965":"5b15d49c692694b0d6b3","6259":"8d8595114515a041f325","6996":"6954039cc03cfb99a2a1","7040":"f23d3eae2fac471d5482","7219":"faf008b430dc64f745c8","7828":"97ca3ca635b9948cd3fd","7893":"67599d461d8af3da59cc","8903":"f6983d28c5358bb2d887","9574":"05b040ad8dbbe4abaf1b","9885":"49de7a515c9384988b80"}[chunkId] + ".chunk.css";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			var cssChunks = {"3":1,"128":1,"423":1,"823":1,"1066":1,"1193":1,"1243":1,"1391":1,"1921":1,"2862":1,"3609":1,"3776":1,"4192":1,"4473":1,"5278":1,"5322":1,"5965":1,"6259":1,"6996":1,"7040":1,"7219":1,"7828":1,"7893":1,"8903":1,"9574":1,"9885":1};
...
/******/ 	__webpack_require__.O(undefined, [1216,504,7550,4772,7211,5110,7017,4998,9968,8483,8135,7591,4654,1844,7341,741,876,995,9602,323,9306,3401,6962,4052,968,4244,9797,3375,4174,9819,599,482], () => (__webpack_require__(26009)))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [1216,504,7550,4772,7211,5110,7017,4998,9968,8483,8135,7591,4654,1844,7341,741,876,995,9602,323,9306,3401,6962,4052,968,4244,9797,3375,4174,9819,599,482], () => (__webpack_require__(82024)))
